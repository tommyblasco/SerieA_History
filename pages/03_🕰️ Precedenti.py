    ...
    if (df1.shape[0]==0) | (df2.shape[0]==0):
        ...
        with colgc1:
            ...
            wh_d_wa1.update_layout(annotations=[
                dict(text=f'{df1['WH'].item() + df1['WA'].item()+ df1['N'].item()}', x=0.5, y=0.55, font_size=25, showarrow=False, xanchor='center'),
                dict(text='match',x=0.5, y=0.45, font_size=15, showarrow=False, xanchor='center')])
        ...
        with colgc3:
            ...
            wh_d_wa2.update_layout(annotations=[
                dict(text=f'{df2['WH'].item() + df2['WA'].item() + df2['N'].item()}', x=0.5, y=0.55, font_size=25, showarrow=False, xanchor='center'),
                dict(text='match',x=0.5, y=0.45, font_size=15, showarrow=False, xanchor='center')])
